...
CREATE INDEX ON dbo.material (materiallevel_id);
...
ALTER TABLE dbo.mainmeasureunit ADD CONSTRAINT FK_mainmeasureunit__measureunit_id FOREIGN KEY (measureunit_id) REFERENCES dbo.measureunit(id);
